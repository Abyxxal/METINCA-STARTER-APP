    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tambah Periode Ujian</h3>
                <p class="text-subtitle text-muted">Tentukan jadwal &amp; rentang ujian untuk acuan supervisor</p>
            </div>
...
<section class="section">
    <div class="card">
        <div class="card-header">
            <h5 class="card-title mb-0"><i class="bi bi-calendar-plus me-1"></i> Form Periode Ujian</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('cbt.admin.exam-periods.store') }}" method="POST">
