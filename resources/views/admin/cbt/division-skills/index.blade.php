...
@section('title', 'Kompetensi Divisi')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Kompetensi Divisi</h3>
                <p class="text-subtitle text-muted">Kelola kompetensi yang berlaku untuk setiap divisi</p>
            </div>
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Kompetensi Divisi</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <div>
                            <h5 class="card-title mb-0">
                                ...
                                Kompetensi untuk: {{ $selectedDivision->name }}
                            </h5>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <form action="{{ route('cbt.admin.division-skills.store') }}" method="POST">
                                ...
                                <div class="modal-header">
                                    <h5 class="modal-title">Tambah Kompetensi untuk {{ $selectedDivision->name }}</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
