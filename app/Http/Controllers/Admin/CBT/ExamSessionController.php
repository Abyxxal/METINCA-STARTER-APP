...
class ExamSessionController extends Controller
{
     ...
     */
    public function __construct(private \App\Services\ExamSessionService $sessionService)
    {
    }

    public function verify(Request $request, ExamSession $session)
    {
        return $this->sessionService->verify($request, $session);
    }
    ...
    {
        return $this->sessionService->approveLevel($request, $session);
    }

    public function rejectLevel(Request $request, ExamSession $session)
    {
        return $this->sessionService->rejectLevel($request, $session);
    }
}
